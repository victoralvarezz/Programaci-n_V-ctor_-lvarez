...
public class PruebaTurnosPartida {
	...
	public static void main(String[] args) {
		...
		String sqlUpdatePartida = "UPDATE Partida "
		...
		parametros.add(true);
		parametros.add(101);
		Utils.updateData(sqlUpdatePartida, parametros);

		String sqlSelect = "SELECT p.nombre, p.tipo, pp.turno, pp.vida_actual, pp.mana_actual, pp.estaVivo, pp.equipo "
